...
s.linkInternalFilters="Javascript:,#,e.huawei.com,enterprise.huawei.com,huawei.com"
...
function s_doPlugins(s) {
  ...
  s.eVar26=s.Util.getQueryParam('source');
    ...
    s.eVar20=s.Util.getQueryParam('category');
  if(s.Util.getQueryParam('keywords')){
    s.eVar21=s.prop21=s.Util.getQueryParam('keywords')  
  }
   if(s.Util.getQueryParam('searchString')){
    s.eVar21=s.prop21=s.Util.getQueryParam('searchString')  
  }
  
   if(s.Util.getQueryParam('ssUserText')){
    s.eVar21=s.prop21=s.Util.getQueryParam('ssUserText')  
  }
    if (s.eVar21){
